 ...
 * Size: 350 px
 * Bpp: 1
 * Opts: --bpp 1 --size 350 --font C:/Users/pizza/Desktop/Github/Cutter_count/SquareLine/assets/ChakraPetch-SemiBold.ttf -o C:/Users/pizza/Desktop/Github/Cutter_count/SquareLine/assets\ui_font_CPM350.c --format lvgl -r 0x30-0x39 --no-compress --no-prefilter
 ******************************************************************************/

#include "../ui.h"

#ifndef UI_FONT_CPM350
#define UI_FONT_CPM350 1
#endif
...
static LV_ATTRIBUTE_LARGE_CONST const uint8_t glyph_bitmap[] = {
    ...
    0x0, 0x0, 0x7, 0xff, 0xff, 0xff, 0xff, 0xff,
    0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
    0x80, 0xff, 0xff, 0xff, 0xff, 0xff, 0x0, 0x0,
    0x3, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 0, .adv_w = 3606, .box_w = 183, .box_h = 245, .ofs_x = 21, .ofs_y = 0},
    {.bitmap_index = 5605, .adv_w = 2094, .box_w = 94, .box_h = 245, .ofs_x = 10, .ofs_y = 0},
    {.bitmap_index = 8484, .adv_w = 3170, .box_w = 170, .box_h = 245, .ofs_x = 14, .ofs_y = 0},
    {.bitmap_index = 13691, .adv_w = 3332, .box_w = 175, .box_h = 245, .ofs_x = 14, .ofs_y = 0},
    {.bitmap_index = 19051, .adv_w = 3198, .box_w = 190, .box_h = 245, .ofs_x = 5, .ofs_y = 0},
    {.bitmap_index = 24870, .adv_w = 3349, .box_w = 174, .box_h = 245, .ofs_x = 17, .ofs_y = 0},
    {.bitmap_index = 30199, .adv_w = 3438, .box_w = 176, .box_h = 245, .ofs_x = 21, .ofs_y = 0},
    {.bitmap_index = 35589, .adv_w = 2878, .box_w = 166, .box_h = 245, .ofs_x = 3, .ofs_y = 0},
    {.bitmap_index = 40673, .adv_w = 3528, .box_w = 182, .box_h = 245, .ofs_x = 19, .ofs_y = 0},
    {.bitmap_index = 46247, .adv_w = 3466, .box_w = 176, .box_h = 245, .ofs_x = 19, .ofs_y = 0}
};
...
#if LVGL_VERSION_MAJOR >= 8
const lv_font_t ui_font_CPM350 = {
#else
lv_font_t ui_font_CPM350 = {
#endif
    .get_glyph_dsc = lv_font_get_glyph_dsc_fmt_txt,    /*Function pointer to get glyph's data*/
    .get_glyph_bitmap = lv_font_get_bitmap_fmt_txt,    /*Function pointer to get glyph's bitmap*/
    .line_height = 245,          /*The maximum line height required by the font*/
